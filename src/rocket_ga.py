...
#
# Defines a genetic algorithm (GA) to generate and evolve a population of AI agents for moving the rocket on the
# platform.
#
# Just like natural selection in bio a genetic algorithm uses these natural selection principles in order to
# create an optimized algorithm. The basic idea is to create a set of possible solutions to a problem, and then use a
# fitness function to evaluate how well each solution performs. The best solutions are then selected to create the
# next generation of solutions through a process of crossover, where elements of two solutions are combined to create
# a new solution.
# ---------------------------------------------------------------------
import random
